...
const textBindings: TextBinding[] = [
  ...
  { elementId: 'tab-btn-ota', key: 'tabOta' },
  ...
  { elementId: 'card-title-ota-version', key: 'otaCurrentVersion' },
  { elementId: 'label-ota-current', key: 'otaLabelInstalled' },
  { elementId: 'card-title-ota-upload', key: 'otaBtnUpload' },
  { elementId: 'label-ota-file', key: 'otaUploadLabel' },
  { elementId: 'ota-upload', key: 'otaBtnUpload' },
